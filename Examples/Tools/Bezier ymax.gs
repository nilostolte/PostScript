...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
25.5115 5.7362 mbzr
-33.5555 24.4622 42.3025 113.573 63.8126 83.1642 cbzr
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% fonction pour determiner le plus grand y de tous les 
% points de la courbe en stockant le resultat en ygt
/ygtr { 
  /ygt -1.0E+38 def 
  { 1 get dup ygt gt 
     { /ygt exch def } 
...
% y de la courbe utilisant sbv et ygtr. La fontion decide
% quelles des deux (left ou right)subdiviser davantage en 
% faisaint la soustraction entre les y maximums de left et
% de right. Si c'est zero la fonction arrete puisque les 
% deux cotes produisent le meme point de maximum y qui est, 
% donc, le point de maximum y de toute la courbe. Si le 
